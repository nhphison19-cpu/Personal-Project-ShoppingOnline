...
// FIX: req.header.token.split('')[1] crashes — req.header is undefined, should be req.headers
// Also split('')[1] splits by empty string (individual chars), should be split(' ')[1]
